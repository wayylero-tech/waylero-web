    ...
    <div className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen flex flex-col`}>
            ...
            <div className="flex flex-col items-start">
              <Link href={getLocalizedLink("/")}>
                <img
                  ...
                  className={`transition-all duration-500 object-contain ${isHome ? "h-14" : "h-12"}`}
                  alt="Waylero logo"
                />
              </Link>
              ...
              {isHome && (
                <div className="mt-2 flex items-center gap-3">
                  ...
                  <div className="flex border rounded-full px-2 py-0.5 text-[10px] font-bold bg-gray-50 gap-2">
                    <button onClick={() => setLang("tr")} className={lang === "tr" ? "text-blue-600 underline" : "text-gray-400"}>
                      TR
                    </button>
                    <span className="text-gray-200">|</span>
                    <button onClick={() => setLang("en")} className={lang === "en" ? "text-blue-600 underline" : "text-gray-400"}>
                      EN
                    </button>
                  </div>
                </div>
      ...
      <footer className="border-t bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 py-6 grid md:grid-cols-3 gap-6 text-sm text-gray-600">
          ...
          {/* SOL */}
          <div>
            <img src="/assets/genel/logo.webp" alt="Waylero Logo" className="h-10 mb-2" />
          ...
          <div className="flex justify-between md:justify-end gap-6">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                ...
                <a href="https://www.instagram.com/waylero_ile_kesfet/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <img src="/assets/genel/instagram.webp" className="h-6 w-6" alt="Instagram" />
                </a>

                <a href="https://www.facebook.com/share/1cc67aspSp/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <img src="/assets/genel/facebook.webp" className="h-6 w-6" alt="Facebook" />
                </a>

                <a href="https://www.youtube.com/@way_lero" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <img src="/assets/genel/youtube.webp" className="h-6 w-6" alt="YouTube" />
                </a>

                <a href="https://x.com/wayylero" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                  <img src="/assets/genel/x.webp" className="h-6 w-6" alt="X (Twitter)" />
                </a>
            ...
            <div className="text-right">
              ...
              <div className="flex gap-2 mt-2">
                ...
                <img src="/assets/genel/app-store.webp" className="h-6 opacity-50" alt="" />
