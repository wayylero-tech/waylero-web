...
export async function generateMetadata({
  ...
  const title = isEn
    ? "About Waylero | Our Story, Vision & Mission"
    : "Hakkımızda | Waylero'nun Hikâyesi, Vizyonu ve Misyonu";

  const description = isEn
    ? "Learn about Waylero, our vision, mission and passion for helping people discover cities, places and travel experiences around the world."
    : "Waylero'nun hikâyesini, vizyonunu ve misyonunu keşfedin. Dünyadaki şehirleri, mekanları ve seyahat deneyimlerini keşfetmenize yardımcı oluyoruz.";

  const url = `${baseUrl}/${isEn ? "en" : "tr"}/hakkimizda`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `${baseUrl}/en/hakkimizda`,
      },
    },
...
export default async function HakkimizdaPage({
  ...
  const content = {
    ...
    storyTitle: isEn
      ? "The Story of Waylero"
      : "Waylero’nun Hikâyesi",
    ...
    offerList: isEn
      ? [
          "Discovery content for cities and places",
          "Travel planning and route creation experience",
          "Photo and video sharing by users",
          "Social interaction and messaging features",
          "Inspiring content based on real experiences",
        ]
      : [
          "Şehirler ve mekanlar için keşif içerikleri",
          "Gezi planlama ve rota oluşturma deneyimi",
          "Kullanıcıların fotoğraf ve video paylaşımı",
          "Sosyal etkileşim ve mesajlaşma özellikleri",
          "Gerçek deneyimlere dayalı ilham verici içerikler",
        ],
  ...
  const pageUrl = `https://www.waylero.com/${isEn ? "en" : "tr"}/hakkimizda`;
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: content.title,
            description: isEn
              ? "Learn about Waylero, its story, vision and mission."
              : "Waylero'nun hikâyesi, vizyonu ve misyonu hakkında bilgi edinin.",
            url: pageUrl,
            isPartOf: {
              "@type": "WebSite",
              name: "Waylero",
        ...
        <div className="grid gap-20 border-t border-gray-50 pt-20">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <section className="space-y-4">
              <h2 className="text-[10px] font-black uppercase tracking-widest text-blue-600 opacity-60">
                {content.visionTitle}
              </h2>
            ...
            <section className="space-y-4 border-l border-gray-100 pl-8">
              <h2 className="text-[10px] font-black uppercase tracking-widest text-orange-600 opacity-60">
          ...
          <div className="space-y-16">
            <section className="max-w-2xl">
              <h2 className="text-4xl font-serif font-bold mb-8 text-gray-900 tracking-tight italic">
              ...
              <p className="text-lg text-gray-400 mt-6 italic font-medium">
                {content.communityP2}
              </p>
            </section>
            ...
            <section className="bg-gray-900 text-white p-12 md:p-20 rounded-[4rem] relative overflow-hidden group">
              ...
              <h2 className="text-sm font-black uppercase tracking-[0.4em] text-orange-500 mb-8">
                {content.futureTitle}
              </h2>

              <p className="text-2xl md:text-3xl text-gray-300 mb-10 leading-tight font-medium">
                {content.futureP1}
              </p>

              <p className="text-4xl md:text-5xl font-serif italic text-white tracking-tighter">
                {content.futureP2}
              </p>
            </section>
          </div>
          ...
          <div className="pt-20 border-t border-gray-50 flex flex-col items-center text-center pb-10">
            <p className="text-4xl font-serif font-bold text-gray-900 mb-4 tracking-tighter italic">
              Waylero
            </p>
