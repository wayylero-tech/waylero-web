...
export async function generateMetadata({
  ...
  const title = isEn
    ? "Contact Waylero | Get in Touch"
    : "Waylero İletişim | Bizimle İletişime Geçin";

  const description = isEn
    ? "Contact Waylero for questions, suggestions, partnerships, advertising and business inquiries."
    : "Sorularınız, önerileriniz, iş birlikleri, reklam ve diğer talepleriniz için Waylero ile iletişime geçin.";

  const url = `${baseUrl}/${isEn ? "en" : "tr"}/contact`;
      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <section className="space-y-12 text-gray-700 leading-relaxed">
          ...
          <div className="bg-orange-50/40 p-10 rounded-[3rem] border border-orange-100/50 italic text-gray-600 text-lg leading-relaxed relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-10 font-serif text-8xl text-orange-900 select-none pointer-events-none">
              ”
            </div>
          ...
          <div className="pt-16 border-t border-gray-50 flex flex-col gap-3">
            <p className="font-serif text-4xl font-bold text-gray-900 tracking-tighter italic">
              Waylero
            </p>
