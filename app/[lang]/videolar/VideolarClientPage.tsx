...
export default function VideolarClientPage({ lang, initialVideos = [] }: VideolarClientPageProps) {
  ...
  const translations = {
    tr: {
      ...
      watchBtn: "Hemen İzle",
      noVideo: "Henüz video eklenmemiş."
    },
    en: {
      badge: "LIVE DISCOVER",
      title: "VIDEOS",
      ...
      watchBtn: "Watch Now",
      noVideo: "No videos found yet."
    }
  };

  // ✅ Dil güvenliği sağlandı
  const t = translations[lang as keyof typeof translations] || translations.tr;

  // ✅ Link oluşturma mantığı params uyumlu hale getirildi
  ...
  if (!initialVideos || initialVideos.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white text-gray-400 font-serif italic text-xl">
        {t.noVideo}
      </div>
    );
  }
